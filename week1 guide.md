...
>[!WARNING]
>Déployer Kubernetes sur un ordinateur personnel sous Linux avec une carte graphique 8Go impose des limites techniques. Cependant, nous allons aussi tester avec des GPU plus puissants sur le cloud d'AWS.
